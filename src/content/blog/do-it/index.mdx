...
import GoldenStar from './golden-star.astro';
import gandalfTooth from './gandalf-tooth.webp';
...
<img
	src={gandalfTooth.src}
	alt="a wide lense image of a grey and white cat's head with one canine showing. They are laying on their side on a cat tree"
/>
