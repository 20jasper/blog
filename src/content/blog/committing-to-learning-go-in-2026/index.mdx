...
import dogComputer from './dog-computer.webp';
...
<Image
	src={dogComputer}
	alt="A LinkedIn banner with a Goldendoodle typing on a laptop. The Go Gopher, Ferris the Crab, Lucy from Gleam, and Tux from Linux are all around the area"
/>
