...
import CarbonIntensity from './carbon-intensity.astro';
import RoundaboutApproachCapacity from './roundabout-approach-capacity.astro';
...
![A graph of funny measured in pounds per meter over meters](./funny-per-polution.png)
...
[^caliCruising]: [“Governor Newsom Issues Legislative Update 10.13.23.”](https://www.gov.ca.gov/2023/10/13/governor-newsom-issues-legislative-update-10-13-23/) Governor of California, 17 June 2024.

Illinois categorizes going around a roundabout more than 2 times as careless driving[^illinois], which is a misdemeanor
[^illinois]: [“Roundabouts FAQ.”](https://idot.illinois.gov/transportation-system/transportation-safety/roadway-safety/engineering/intersections/idot-roundabouts/faq.html#:~:text=Circling%20a%20roundabout%20more%20than,exit%20at%20the%20desired%20street) Illinois Department of Transportation. Accessed 18 Jan. 2025.
...
[^indiana]: WTHR.com staff. [“Comedian Dave Dugan Breaks World Record in Carmel for Time Spent in a Roundabout.”](https://www.wthr.com/article/news/local/dave-dugan-carmel-roundabout-world-record-carmel/531-b757fea9-df4b-4f16-a2ad-4b805cec10ee) WTHR, 11 May 2022.
...
{/* prettier-ignore */}
[^2]: <cite><a href="https://www.scdot.org/content/dam/scdot-legacy/business/pdf/i26widening/attachb/roadway/Roundabout_Criteria.pdf">“9.1.1 Roundabout Design Criteria.” South Carolina Department of Transportation.</a></cite>
...
![A two lane roundabout with cars laid back to back to measure the diameter](./inscribed-diameter.png)
...
![A two lane roundabout with cars almost touching each other](./full-roundabout.png)
...
![A two lane roundabout with cars 3 car lengths away from each other](./reasonably-filled-roundabout.png)
...
![Roundabouts in the shape of the FIFA logo next to the real FIFA logo to compare](./fifa-roundabout.png)
