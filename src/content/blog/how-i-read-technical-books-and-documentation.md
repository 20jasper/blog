...
Since I have a [reading list](https://jacobasper.com/reading-list) on my blog, I often get asked "how do you read so much?" or "why read books when I can do tutorials and researching as I go?"

To put it briefly, [consuming longform content provides a mental model that shortform content cannot](#why-read), [scope what you want to read](#what-to-read), [adjust when things don't go to plan](#how-to-read), [set aside time to read](#when-to-read), and finally [do it](#do-it)
...
How can you know the answers you get online, from blogs, or from LLM responses are relevant to you? How do you know they are up to date and make sense for your use case? That's right! Put on your nerd glasses[^nerd], we are going to read the manual!

![nerd emoji with glasses](/nerd.webp)

[^nerd]: I copied this image into my blog, only to find that I already used it a year ago
...
Recently I started reading _Writing For Developers_. My goal is to think more about writing and pick up a few tips along the way
...
I get a lot of value out of recalling what I read afterwards or applying the concepts in the real world. For example, [I am learning about concurrency via translating a Rust tutorial to Go](https://jacobasper.com/blog/committing-to-learning-go-in-2026/#how-will-i-learn-go)
...
Now, go read a book! You made it to the end of the article, now [do it](https://jacobasper.com/blog/do-it/)
