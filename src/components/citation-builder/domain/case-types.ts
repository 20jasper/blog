...
// Rule 10.2.1: data table, not branches -- new type = one record.
// r[impl case-type.data]
export const CASE_TYPES: CaseType[] = [V, IN_RE, EX_PARTE];

// Total by construction: CaseTypeId is closed, compiler checks coverage.
...
// Narrows an untyped DOM value (e.g. <select>.value) instead of casting.
